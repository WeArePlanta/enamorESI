...
<head>
    ...
    <meta itemProp="image" property="og:image" content="https://enamoresi.org/enamoreis/favicon/android-icon-192x192.png" />
    <meta property="og:locale" content="es">
    <meta property="og:image" content="https://enamoresi.org/enamoreis/favicon/android-icon-192x192.png" />
	...
	<meta name="twitter:image" content="https://enamoresi.org/enamoreis/favicon/android-icon-192x192.png"/>
</head>
...
<body>
	<header>
		<section class="principal-logos">
			<picture>
				<!-- Desktop -->
				<source media="(min-width:980px)" srcset="../img/Logo-EIS.svg" alt="Logo Eis Igualdad">
				<!-- Mobile  -->
				<img src="../img/Logo-EIS.svg" alt="Logo Eis Igualdad">
			</picture>
			<picture>
				<!-- Desktop -->
		...
		<picture class="enamoresi-title">
			<!-- Desktop -->
			<source media="(min-width:980px)" srcset="../img/enamorEIS.png" alt="EnamorEis">
			<!-- Mobile  -->
			<img src="../img/enamorEIS.png" alt="EnamorEis">
		</picture>
